...
function _export(_a) {
    ...
    return index.__awaiter(this, void 0, void 0, function () {
        ...
        function handleResponse(fetched, fetchOpts) {
            return index.__awaiter(this, void 0, void 0, function () {
                var _a, response, url, pathname, type, body, _b, range, link, cleaned, base_match, base_href, base, match, pattern, hrefs, element, attrs, hrefs_1, hrefs_1_1, href, dest, location_1;
                var e_1, _c;
                return index.__generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, fetched];
                        case 1:
                            _a = _d.sent(), response = _a.response, url = _a.url;
                        ...
                        case 5:
                            ...
                            if (range === 2 && type === 'text/html') {
                                ...
                                if (pathname !== '/service-worker-index.html') {
                                    ...
                                    match = void 0;
                                    pattern = /<(a|img|link|source)\s+([\s\S]+?)>/gm;
                                    while (match = pattern.exec(cleaned)) {
                                        ...
                                        if (element === 'a' || element === 'link') {
                                            ...
                                            hrefs.push.apply(hrefs, index.__spread(get_srcset_urls(attrs)));
                                        }
                                        hrefs = hrefs.filter(Boolean);
                                        try {
                                            for (hrefs_1 = (e_1 = void 0, index.__values(hrefs)), hrefs_1_1 = hrefs_1.next(); !hrefs_1_1.done; hrefs_1_1 = hrefs_1.next()) {
                                                href = hrefs_1_1.value;
                                                dest = resolve(base.href, href);
                                            ...
                                            try {
                                                if (hrefs_1_1 && !hrefs_1_1.done && (_c = hrefs_1.return)) _c.call(hrefs_1);
                                            }
                            ...
                            if (range === 3) {
                                ...
                                handle(resolve(fetchOpts.root.href, location_1), fetchOpts, queue.add);
                            }
        ...
        var has_serviceworker, defaultPort, port, protocol, host, origin, root, entryPoints, proc, seen, saved, queueFetchOpts, queue;
        return index.__generator(this, function (_m) {
            switch (_m.label) {
                case 0:
                    ...
                    has_serviceworker = fs.existsSync(path.join(build_dir, 'service-worker.js'));
                ...
                case 1:
                    ...
                    entryPoints = entry.split(' ').map(function (entryPoint) {
                        var resolved = resolve(origin, basepath + "/" + cleanPath(entryPoint));
                    ...
                    return [2 /*return*/, new Promise(function (res, rej) {
                            ...
                            Deferred.wait(port).then(function () {
                                ...
                                try {
                                    try {
                                        for (var entryPoints_1 = index.__values(entryPoints), entryPoints_1_1 = entryPoints_1.next(); !entryPoints_1_1.done; entryPoints_1_1 = entryPoints_1.next()) {
